...
public class DsinterfaceApp {

    private static final Logger log = LoggerFactory.getLogger(DsinterfaceApp.class);

    private final Environment env;

    public DsinterfaceApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes dsinterface.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(DsinterfaceApp.class);
